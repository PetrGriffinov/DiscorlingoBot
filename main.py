...
GUILD_ID = discord.Object(id=1294286676301975612)
...
@bot.tree.command(name="start", description="Start your learning", guild=GUILD_ID)
async def startLearning(interaction: discord.Interaction):
